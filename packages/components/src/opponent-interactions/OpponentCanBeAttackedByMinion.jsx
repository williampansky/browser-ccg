...
export default function OpponentCanBeAttackedByMinion(props) {
  ...
  return (
    <animated.div
      ...
      data-file="opponent-interactions/CanBeAttackedByMinion"
      onClick={onClick}
      onKeyPress={onClick}
      role="button"
      tabIndex={0}
...
OpponentCanBeAttackedByMinion.propTypes = {
  activeState: PropTypes.bool,
  onClick: PropTypes.func
};

OpponentCanBeAttackedByMinion.defaultProps = {
  activeState: false,
  onClick: () => {}
};
