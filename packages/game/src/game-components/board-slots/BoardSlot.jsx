...
import { PLAYER_BOARDS, PLAY_TYPE, RACE, RARITY, SET, TYPE } from '@ccg/enums';
import {
  MECHANICS,
  SETS as SET_IMAGES,
  PLACEHOLDER_IMAGE,
...
import HasBoon from '../mechanics/HasBoon';
import HasBubble from '../mechanics/HasBubble';
import HasBulwarkBackground from '../mechanics/HasBulwarkBackground';
import HasBulwarkForeground from '../mechanics/HasBulwarkForeground';
import HasCurse from '../mechanics/HasCurse';
import HasDoubleAttack from '../mechanics/HasDoubleAttack';
import IsConcealed from '../mechanics/IsConcealed';
import IsDisabled from '../mechanics/IsDisabled';
import IsElite from '../mechanics/IsElite';
import MinionInteraction from '../interactions/minions/MinionInteraction';
import WillExpire from '../mechanics/WillExpire';
    ...
    >
      ...
      {minionData && (
        <Minion
          ...
          id={id}
          imageFlairSrc={getMinionFlairImage(id, set, SET_IMAGES)}
          isAttacking={isAttacking}
          isGolden={isGolden}
          mechanics={mechanics}
          name={name}
