...
import buffMinionPhase from './style-extended/buff-minion/buff-minion.phase';
import destroyMinionPhase from './style-extended/destroy-minion/destroy-minion.phase';
